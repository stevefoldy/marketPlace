...
if ($_GET['submit']) // ha megtörtént a gombnyomás, átvesszük az értékeket és betöltjük az adabázisba (frissítés)
{
    ...
    if ($data) {
        echo "<font color='green'>Rekord frissítve! <a href=product_table.php>Nézd meg a frissített listát</a>";
    }
    else
    {
        echo "<font color='red'>Rekord nincs frissítve! <a href=product_table.php>Nézd meg a listát</a>";
    }
